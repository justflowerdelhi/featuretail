  ...
  return (
    <footer className="bg-gray-100 mt-4">
      ...
      <div className="text-center text-sm text-gray-500 py-4 border-t">
        © {new Date().getFullYear()} {store?.name || "3A Featuretail"}. All rights reserved.
        <div className="text-xs text-gray-400 mt-4">
          © {new Date().getFullYear()} {store?.name || "3A Featuretail"} • Powered by Floraprise
        </div>
      </div>
    </footer>
  );
